...
F1 = {
    'survey': [
        ...
        {
            'name': 'Select_one',
            'select_from_list_name': 'choice_list_1',
            'required': 'true',
            'label': [
                'Select one',
                'Seleccione uno',
    ...
    'translations': [None, 'Espa\xf1ol', 'Arabic'],
    'choices': [
        {
            '$kuid': 'xm4h0m4kK',
            'list_name': 'choice_list_1',
            'name': 'option_1',
            'label': [
                'First option',
                'Primera opci\xf3n',
...
>>>>>>> /tmp/kpiport/mf/fork
    ...
    stats = []
    for field, name_or_label, data in report.get_stats(
        submissions,
        field_names,
        lang=lang,
        split_by=split_by,
...
class MockDataReports(BaseSubmissionTestCase):
    ...
    def test_kobo_apps_reports_report_data_subset(self):
        ...
        self.assertEqual(
            values[0]['data']['responses'], ('First option', 'Second option')
        )
    ...
    def test_formpack_results(self):
        ...
        self.assertEqual(
            _get_autoreport_values('Select_one', 'frequency', None, 0),
            ['First option', 'Second option'],
        )
        self.assertEqual(
            _get_autoreport_values('Select_one', 'frequency', 'Espa\xf1ol', 0),
