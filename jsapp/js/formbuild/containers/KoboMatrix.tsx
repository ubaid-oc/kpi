...
/**
 * The plain object structure generated by KoboMatrix's `.toJS()`
 */
export interface KoboMatrixPlainData {
  /**
   * Array of KUIDs representing the matrix columns. See `data.get('cols')`
   */
  cols: string[]

  /**
   * 'choices' here is a flat map of ALL matrix-related rows and options.
   * It contains both the Matrix Rows (the questions) and
   * the Matrix Options (for `select_one` columns).
   */
  choices: Record<string, KoboMatrixDataChoice>

  /**
   * The matrix object also contains the column definitions
   * indexed directly by their KUID at the top level.
   */
  [kuid: string]: any
}
