  ...
  xlfRowView = (surveyView) ->
      ...
      if surveyView.features.multipleQuestions
        ...
        if surveyView.canAddToLibrary()
          template += """<span class="card__buttons__button card__buttons__button--add card__buttons__button--teal js-add-to-question-library" data-button-name="add-to-library"><i class="k-icon k-icon-folder-plus"></i></i></span>"""
